...
package Parts
  ...
  model Fixed "Frame fixed in the world frame at a given position"
    ...
    parameter Types.ShapeExtra extra=0.0
      ...
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input Types.Color color=MultiBodyOmc.Types.Defaults.RodColor
      " Color of shape"
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
...
<IMG SRC=\"../Images/MultiBodyOmc/Fixed.png\" ALT=\"Parts.Fixed\">
</HTML>
...
<IMG SRC=\"../Images/MultiBodyOmc/FixedTranslation.png\" ALT=\"Parts.FixedTranslation\">
</HTML>"));
  ...
  model FixedRotation
    ...
    parameter SI.Position r[3]={0,0,0}
      "Vector from frame_a to frame_b resolved in frame_a";
    parameter MultiBodyOmc.Types.RotationTypes rotationType=
              MultiBodyOmc.Types.RotationTypes.RotationAxis
    ...
    parameter Types.Axis n={1,0,0}
      ...
      annotation (Evaluate=true, Dialog(group="if rotationType = RotationAxis",
                  enable=rotationType==MultiBodyOmc.Types.RotationTypes.RotationAxis));
...
*/
    ...
    MultiBodyOmc.Visualizers.Advanced.Shape shape(
      shapeType=shapeType,
      color=color,
      specularCoefficient=specularCoefficient,
      r_shape=r_shape,
...
<IMG SRC=\"../Images/MultiBodyOmc/FixedRotation.png\" ALT=\"Parts.FixedRotation\">
...
<ul>
  ...
  model Body
    ...
    SI.Position r_0[3](start={0,0,0}, each stateSelect=if enforceStates then StateSelect.always else StateSelect.avoid)
    ...
    SI.Velocity v_0[3](start={0,0,0}, each stateSelect=if enforceStates then StateSelect.always else StateSelect.avoid)
    ...
    parameter SI.Diameter sphereDiameter=world.defaultBodyDiameter
      "Diameter of sphere" annotation (Dialog(
        ...
        enable=animation));
    input Types.Color sphereColor=MultiBodyOmc.Types.Defaults.BodyColor
    ...
    final parameter Frames.Orientation R_start=MultiBodyOmc.Frames.axesRotations(
...
<IMG SRC=\"../Images/MultiBodyOmc/Body.png\" ALT=\"Parts.Body\">
<p>
...
\"sequence_angleStates\".
  ...
  model BodyShape
    ...
    parameter Types.ShapeExtra extra=0.0
      " Additional parameter depending on shapeType (see docu of Visualizers.Advanced.Shape)."
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input Types.Color color=MultiBodyOmc.Types.Defaults.BodyColor
      " Color of shape"
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
...
defined with MultiBodyOmc.Visualizers.FixedShape. This shape is placed
...
<IMG SRC=\"../Images/MultiBodyOmc/BodyShape.png\" ALT=\"Parts.BodyShape\">
<p>
The following shapes can be defined via parameter <b>shapeType</b>,
e.g., shapeType=\"cone\":
</p>
<IMG SRC=\"../Images/MultiBodyOmc/FixedShape.png\" ALT=\"Visualizers.FixedShape\">
<p>
A BodyShape component has potential states. For details of these
states and of the \"Advanced\" menu parameters, see model
<a href=\"Modelica://MultiBodyOmc.Parts.Body\">MultiBodyOmc.Parts.Body</a>.
</p>
</HTML>
"),   Icon(coordinateSystem(
          preserveAspectRatio=true,
  ...
  model BodyBox
    ...
    parameter MultiBodyOmc.Types.Axis lengthDirection=r - r_shape
      "Vector in length direction of box, resolved in frame_a"
      annotation (Evaluate=true);
    parameter MultiBodyOmc.Types.Axis widthDirection={0,1,0}
    ...
    input MultiBodyOmc.Types.Color color=MultiBodyOmc.Types.Defaults.BodyColor
      "Color of box"
...
<IMG SRC=\"../Images/MultiBodyOmc/BodyBox.png\" ALT=\"Parts.BodyBox\">
<p>
A BodyBox component has potential states. For details of these
states and of the \"Advanced\" menu parameters, see model
<a href=\"Modelica://MultiBodyOmc.Parts.Body\">MultiBodyOmc.Parts.Body</a>.</p>
</HTML>
"),   Icon(coordinateSystem(
          preserveAspectRatio=true,
          extent={{-100,-100},{100,100}},
...
<IMG SRC=\"../Images/MultiBodyOmc/BodyCylinder.png\" ALT=\"Parts.BodyCylinder\">
<p>
A BodyCylinder component has potential states. For details of these
states and of the \"Advanced\" menu parameters, see model
<a href=\"Modelica://MultiBodyOmc.Parts.Body\">MultiBodyOmc.Parts.Body</a>.</HTML>
"),   Icon(coordinateSystem(
          preserveAspectRatio=true,
          extent={{-100,-100},{100,100}},
          grid={1,1}), graphics={
...
A MultiBodyOmc.Parts.PointMass model is connected in
...
MultiBodyOmc.Joints.FreeMotion joint.
...
are forced to be used as states.
  ...
  model Mounting1D
    ...
    MultiBodyOmc.Interfaces.Frame_a frame_a if world.driveTrainMechanics3D
...
"),   Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{
  ...
  model Rotor1D
    ...
    parameter SI.Distance cylinderDiameter=2*world.defaultJointWidth
      ...
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input MultiBodyOmc.Types.Color cylinderColor=MultiBodyOmc.Types.Defaults.RodColor
  ...
  encapsulated model RotorWith3DEffects
    ...
    parameter SI.Distance cylinderDiameter=2*world.defaultJointWidth
        "Diameter of cylinder representing the rotor"
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input Types.Color cylinderColor=MultiBodyOmc.Types.Defaults.RodColor
        "Color of cylinder representing the rotor"
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input Types.SpecularCoefficient specularCoefficient =                              world.defaultSpecularCoefficient
        "Reflection of ambient light (= 0: light is completely absorbed)"
    ...
    MultiBodyOmc.Visualizers.Advanced.Shape cylinder(
      shapeType="cylinder",
      color=cylinderColor,
      specularCoefficient=specularCoefficient,
  ...
  equation
    ...
    w_a = MultiBodyOmc.Frames.angularVelocity2(frame_a.R);
    if exact then
...
shown in the figure below. </p>
      <IMG SRC=\"../Images/MultiBodyOmc/Parts/Rotor1D.png\" ALT=\"model Parts.Rotor1D\">
...
"),   Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{100,
  ...
  protected
    ...
    MultiBodyOmc.Visualizers.Advanced.Shape cylinder(
      ...
      r_shape=r_center - e*(cylinderLength/2),
      r=zeros(3),
      R=MultiBodyOmc.Frames.planarRotation(
          e,
          phi,
...
November 3-4, 2003, pp. 149-158</p>
    ...
    "Ideal rolling wheel on flat surface z=0 (5 positional, 3 velocity degrees of freedom)"
      ...
      "1.0: Completely hollow, 0.0: rigid cylinder"     annotation (Dialog(
          tab="Animation",
          group="if animation = true", enable=animation));
      parameter MultiBodyOmc.Types.Color wheelColor={30,30,30}
      "Color of wheel"    annotation (Dialog(
          tab="Animation",
          group="if animation = true",
          enable=animation));

      MultiBodyOmc.Parts.Body body(
        final r_CM={0,0,0},
        final m=wheelMass,
      ...
      MultiBodyOmc.Joints.RollingWheel rollingWheel(wheelRadius=wheelRadius,
          stateSelect=StateSelect.avoid)
        annotation (Placement(transformation(extent={{-60,-60},{-40,-40}})));
      MultiBodyOmc.Visualizers.FixedShape fixedShape(
     ...
     MultiBodyOmc.Interfaces.Frame_a frameMiddle
      ...
      MultiBodyOmc.Parts.Body body2(
        ...
        annotation (Placement(transformation(extent={{10,-10},{-10,10}},
            rotation=-90,
            origin={60,30})));
      MultiBodyOmc.Visualizers.FixedShape shape2(
        final animation=animation,
        final lengthDirection={0,1,0},
        final widthDirection={1,0,0},
        final color=wheelColor,
      ...
      MultiBodyOmc.Parts.Body body1(
        ...
        annotation (Placement(transformation(extent={{-10,-10},{10,10}},
            rotation=90,
            origin={-60,30})));
      MultiBodyOmc.Visualizers.FixedShape shape1(
        final animation=animation,
        final lengthDirection={0,1,0},
        final widthDirection={1,0,0},
        final color=wheelColor,
      ...
      MultiBodyOmc.Joints.RollingWheelSet wheelSetJoint(
        animation=false,
...
<table border=1 cellspacing=0 cellpadding=2>
  ...
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.Fixed\">Fixed</a></td>
      ...
      <IMG SRC=\"../Images/MultiBodyOmc/Fixed.png\" ALT=\"model Parts.Fixed\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.FixedTranslation\">FixedTranslation</a></td>
      ...
      <IMG SRC=\"../Images/MultiBodyOmc/FixedTranslation.png\" ALT=\"model Parts.FixedTranslation\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.FixedRotation\">FixedRotation</a></td>
      <td valign=\"top\">Fixed translation and fixed rotation of frame_b with respect to frame_a
          It is visualized with a shape, see <b>shapeType</b>  below
          (the frames on the two sides do not belong to the component):<br>&nbsp;<br>
      <IMG SRC=\"../Images/MultiBodyOmc/FixedRotation.png\" ALT=\"model Parts.FixedRotation\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.Body\">Body</a></td>
      ...
      <IMG SRC=\"../Images/MultiBodyOmc/Body.png\" ALT=\"model Parts.Body\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.BodyShape\">BodyShape</a></td>
      ...
      <IMG SRC=\"../Images/MultiBodyOmc/BodyShape.png\" ALT=\"model Parts.BodyShape\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.Fixed\">Fixed</a>
BodyBox</b></td>
      <td valign=\"top\">Rigid body with box shape (mass and animation properties are computed
          from box data and from density):<br>&nbsp;<br>
      <IMG SRC=\"../Images/MultiBodyOmc/BodyBox.png\" ALT=\"model Parts.BodyBox\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.BodyCylinder\">BodyCylinder</a></td>
      ...
      <IMG SRC=\"../Images/MultiBodyOmc/BodyCylinder.png\" ALT=\"model Parts.BodyCylinder\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.PointMass\">PointMass</a></td>
      <td valign=\"top\">Rigid body where inertia tensor and rotation is neglected:<br>&nbsp;<br>
      <IMG SRC=\"../Images/MultiBodyOmc/Parts/PointMass.png\" ALT=\"model Parts.PointMass\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.Mounting1D\">Mounting1D</a></td>
      <td valign=\"top\"> Propagate 1-dim. support torque to 3-dim. system
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.Rotor1D\">Rotor1D</a></td>
      <td valign=\"top\">1D inertia attachable on 3-dim. bodies (without neglecting dynamic effects)<br>
      <IMG SRC=\"../Images/MultiBodyOmc/Parts/Rotor1D.png\" ALT=\"model Parts.Rotor1D\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Parts.BevelGear1D\">BevelGear1D</a></td>
...
<IMG SRC=\"../Images/MultiBodyOmc/FixedShape.png\" ALT=\"model Visualizers.FixedShape\">
<p>
All the details of the visualization shape parameters are
given in
<a href=\"Modelica://MultiBodyOmc.Visualizers.FixedShape\">Visualizers.FixedShape</a>
</p>
<p>
...
<b>MultiBodyOmc.Types.Color</b> contains a menu
definition of the colors used in the MultiBodyOmc library
