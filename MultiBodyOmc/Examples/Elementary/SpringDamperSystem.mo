...
model SpringDamperSystem "Simple spring/damper/mass system"
  ...
  MultiBodyOmc.Parts.Body body1(
    ...
    w_0_start(displayUnit="deg/s") = {0,0,0.03490658503988659})
        ...
        extent={{-10,10},{10,-10}},
        rotation=270)));
  MultiBodyOmc.Parts.FixedTranslation bar1(animation=animation, r={0.3,0,0})
    annotation (Placement(transformation(extent={{-46,20},{-26,40}}, rotation=0)));
  MultiBodyOmc.Parts.FixedTranslation bar2(animation=animation, r={0.6,0,0})
  ...
  MultiBodyOmc.Parts.Body body2(
    ...
    r_CM={0,0,0})        annotation (Placement(transformation(
        ...
        extent={{-10,10},{10,-10}},
        rotation=270)));
  MultiBodyOmc.Joints.Prismatic p2(useAxisFlange=true,
    n={0,-1,0},
    animation=animation,
    boxWidth=0.05,
    ...
    s(fixed=true, start=0.1))
        ...
        extent={{-10,-10},{10,10}},
        rotation=270)));
  MultiBodyOmc.Forces.Spring spring2(
    c=30,
    s_unstretched=0.1,
    coilWidth=0.01,
    width=0.1) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=270)));
  MultiBodyOmc.Forces.Spring spring1(
    s_unstretched=0.1,
    coilWidth=0.01,
    c=30,
    numberOfWindings=10,
    width=0.1) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=270)));
  MultiBodyOmc.Forces.Damper damper1(d=2)
    annotation (Placement(transformation(
        origin={-30,-10},
        extent={{-10,-10},{10,10}},
        rotation=270)));
