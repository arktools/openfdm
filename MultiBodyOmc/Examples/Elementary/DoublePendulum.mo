...
model DoublePendulum
  ...
  MultiBodyOmc.Joints.Revolute revolute1(useAxisFlange=true,phi(fixed=true),
  ...
  MultiBodyOmc.Parts.BodyBox boxBody1(r={0.5,0,0}, width=0.06)
  ...
  MultiBodyOmc.Joints.Revolute revolute2(phi(fixed=true), w(
        fixed=true))                                     annotation (Placement(transformation(extent={{32,0},{
            52,20}}, rotation=0)));
  MultiBodyOmc.Parts.BodyBox boxBody2(r={0.5,0,0}, width=0.06)
