...
model PointGravityWithPointMasses2
  ...
  model PointMass = MultiBodyOmc.Parts.PointMass (m=1, sphereColor={
  ...
  MultiBodyOmc.Parts.FixedTranslation fixedTranslation(r={1,0,0})
                  annotation (Placement(transformation(extent={{20,-10},{40,10}},
          rotation=0)));
  MultiBodyOmc.Parts.FixedTranslation fixedTranslation1(r={-1,0,0})
                 annotation (Placement(transformation(extent={{0,-10},{-20,10}},
          rotation=0)));
  MultiBodyOmc.Parts.FixedTranslation fixedTranslation2(r={0,1,0})
                 annotation (Placement(transformation(extent={{20,20},{40,40}},
          rotation=0)));
  MultiBodyOmc.Parts.FixedTranslation fixedTranslation3(r={0,-1,0})
                 annotation (Placement(transformation(extent={{0,-40},{-20,-20}},
          rotation=0)));
  MultiBodyOmc.Parts.FixedTranslation fixedTranslation4(r={0,0,1})
                 annotation (Placement(transformation(
        origin={10,60},
        extent={{-10,-10},{10,10}},
        rotation=90)));
  MultiBodyOmc.Parts.FixedTranslation fixedTranslation5(r={0,0,-1})
                 annotation (Placement(transformation(
        origin={10,-60},
        extent={{10,-10},{-10,10}},
        rotation=90)));

  inner World world(                             gravityType=MultiBodyOmc.Types.GravityTypes.PointGravity, mue=
        5)
...
model SystemWithStandardBodies
  ...
  extends Modelica.Icons.Example;
  model PointMass = MultiBodyOmc.Parts.Body(m=1,I_11=0,I_22=0,I_33=0)
