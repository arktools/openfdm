within MultiBodyOmc.Examples.Systems;
package RobotR3
  ...
  model fullRobot
    ...
    Components.MechanicalStructure mechanics(
      ...
      g=g) annotation (Placement(transformation(extent={{35,-35},{95,25}},
            rotation=0)));
    MultiBodyOmc.Examples.Systems.RobotR3.Components.PathPlanning6
      pathPlanning(
      naxis=6,
...
<a href=\"Modelica://MultiBodyOmc.Examples.Systems.RobotR3.Components.InternalConnectors.AxisControlBus\">here</a>.
</p>
...
(and are by default listed as choices in the menu that defines
the connection to this bus) are defined
<a href=\"Modelica://MultiBodyOmc.Examples.Systems.RobotR3.Components.InternalConnectors.ControlBus\">here</a>.
</p>
</html>"));
    end ControlBus;
    ...
    model Motor "Motor model including current controller of r3 motors "
      ...
      Modelica.Mechanics.Rotational.Components.Inertia Jmotor(
        ...
        annotation (Placement(transformation(extent={{70,-10},{90,10}},
              rotation=0)));
      MultiBodyOmc.Examples.Systems.RobotR3.Components.AxisControlBus
        axisControlBus
    ...
    model MechanicalStructure
      ...
      Modelica.Mechanics.Rotational.Interfaces.Flange_a axis6
        annotation (Placement(transformation(extent={{-220,120},{-200,140}},
              rotation=0)));
      inner MultiBodyOmc.World world(
      ...
      MultiBodyOmc.Joints.Revolute r1(n={0,1,0},useAxisFlange=true,
          animation=animation)
        annotation (Placement(transformation(
            origin={-70,-160},
            extent={{-10,-10},{10,10}},
            rotation=90)));
      MultiBodyOmc.Joints.Revolute r2(n={1,0,0},useAxisFlange=true,
          animation=animation)
        annotation (Placement(transformation(extent={{-50,-110},{-30,-90}},
              rotation=0)));
      MultiBodyOmc.Joints.Revolute r3(n={1,0,0},useAxisFlange=true,
          animation=animation)
        annotation (Placement(transformation(
            origin={-50,-36},
            extent={{-10,-10},{10,10}},
            rotation=180)));
      MultiBodyOmc.Joints.Revolute r4(n={0,1,0},useAxisFlange=true,
          animation=animation)
        annotation (Placement(transformation(
            origin={-70,10},
            extent={{-10,-10},{10,10}},
            rotation=90)));
      MultiBodyOmc.Joints.Revolute r5(n={1,0,0},useAxisFlange=true,
          animation=animation)
        annotation (Placement(transformation(extent={{-60,70},{-40,90}},
              rotation=0)));
      MultiBodyOmc.Joints.Revolute r6(n={0,1,0},useAxisFlange=true,
          animation=animation)
        annotation (Placement(transformation(
            origin={-60,130},
            extent={{-10,-10},{10,10}},
            rotation=90)));
      MultiBodyOmc.Parts.BodyShape b0(
        r={0,0.351,0},
        shapeType="0",
        r_shape={0,0,0},
        ...
        annotation (Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=90)));
      MultiBodyOmc.Parts.BodyShape b1(
        r={0,0.324,0.3},
        I_22=1.16,
        shapeType="1",
        lengthDirection={1,0,0},
        ...
        m=1)             annotation (Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=90)));
      MultiBodyOmc.Parts.BodyShape b2(
        r={0,0.65,0},
        r_CM={0.172,0.205,0},
        m=56.5,
        I_11=2.58,
        ...
        color={255,178,0}) annotation (Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=90)));
      MultiBodyOmc.Parts.BodyShape b3(
        r={0,0.414,-0.155},
        r_CM={0.064,-0.034,0},
        m=26.4,
        I_11=0.279,
        ...
        color={255,0,0}) annotation (Placement(transformation(
            ...
            extent={{-10,10},{10,-10}},
            rotation=90)));
      MultiBodyOmc.Parts.BodyShape b4(
        r={0,0.186,0},
        r_CM={0,0,0},
        m=28.7,
        I_11=1.67,
        ...
        color={255,178,0}) annotation (Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=90)));
      MultiBodyOmc.Parts.BodyShape b5(
        r={0,0.125,0},
        r_CM={0,0,0},
        m=5.2,
        I_11=1.25,
        ...
        color={0,0,255}) annotation (Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=90)));
      MultiBodyOmc.Parts.BodyShape b6(
        r={0,0,0},
        r_CM={0.05,0.05,0.05},
        m=0.5,
        shapeType="6",
        ...
        color={0,0,255}) annotation (Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=90)));
      MultiBodyOmc.Parts.BodyShape load(
        r_CM=rLoad,
        m=mLoad,
        r_shape={0,0,0},
...
"),     Icon(coordinateSystem(
    ...
    package InternalConnectors "Internal models that should not be used"
      ...
      expandable connector ControlBus "Data bus for all axes of robot"
        extends
          MultiBodyOmc.Examples.Systems.RobotR3.Components.ControlBus;
        MultiBodyOmc.Examples.Systems.RobotR3.Components.AxisControlBus
  ...
  MultiBodyOmc.Examples.Systems.RobotR3.Components.Internal.AxisControlBus
