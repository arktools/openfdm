...
in package MultiBodyOmc.Frames. As a consequence, it is not necessary to know
...
and/or a division by zero will occur.
  ...
  function axesRotations
    ...
    import TM = MultiBodyOmc.Frames.TransformationMatrices;
    extends Modelica.Icons.Function;
  ...
  package Quaternions
    ...
    type Orientation
      ...
      encapsulated function equalityConstraint
        ...
        import Modelica;
        import MultiBodyOmc.Frames.Quaternions;
        extends Modelica.Icons.Function;
...
MultiBodyOmc.Parts.Body components, when quaternions shall be used
  ...
  package TransformationMatrices "Functions for transformation matrices"
    ...
    type Orientation
      ...
      encapsulated function equalityConstraint
        ...
        import Modelica;
        import MultiBodyOmc.Frames.TransformationMatrices;
        extends Modelica.Icons.Function;
...
<p>
Note, that in the MultiBodyOmc library the rotation object is
...
<table border=1 cellspacing=0 cellpadding=2>
  ...
  package Internal
    ...
    function maxWithoutEvent
      ...
      input Real u2;
      output Real y;
      //  annotation (Header="#include \"MultiBodyOmc.h\"");
    protected
      Integer dummy;
    algorithm
...
in these cases. For the special cases as used in the MultiBodyOmc
...
<table border=1 cellspacing=0 cellpadding=2>
  ...
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Frames.Quaternions\">Quaternions</a></td>
  ...
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Frames.TransformationMatrices\">TransformationMatrices</a></td>
      <td valign=\"top\"><b>Package</b> with functions to transform rotational frame quantities based
