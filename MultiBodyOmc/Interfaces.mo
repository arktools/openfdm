...
This component has a non-filled rectangular icon.
  ...
  connector FlangeWithBearing
    ...
    MultiBodyOmc.Interfaces.Frame bearingFrame if
...
<a href=\"Modelica://MultiBodyOmc.Interfaces.FlangeWithBearingAdaptor\">FlangeWithBearingAdaptor</a>
to the FlangeWithBearing connector.
  ...
  model FlangeWithBearingAdaptor
    ...
    MultiBodyOmc.Interfaces.FlangeWithBearing flangeAndFrame(
...
subconnectors of a
<a href=\"Modelica://MultiBodyOmc.Interfaces.FlangeWithBearing\">FlangeWithBearing</a>
connector.
</p>
</html>"));
...
<pre>
   <b>model</b> Constant_x_Force
      extends MultiBodyOmc.Interfaces.PartialForce;
   <b>equation</b>
      frame_b.f = {-100, 0, 0};
      frame_b.t = zeros(3);
...
<pre>
   <b>model</b> Spring
      ...
      <b>extends</b> MultiBodyOmc.Interfaces.PartialLineForce;
   <b>equation</b>
      f = c*(s-s_unstretched);
   <b>end</b> Spring;
</pre>
...
It is used by inheritance from all visualizer objects.
  ...
  equation
    ...
    frame_resolve.R = MultiBodyOmc.Frames.nullRotation();
...
that are only used to build other models) of the MultiBodyOmc library.
</p>
</html>"));
end Interfaces;
