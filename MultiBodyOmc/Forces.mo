...
package Forces "Components that exert forces and/or torques between frames"
  ...
  model WorldForce
    ...
    Interfaces.Frame_resolve frame_resolve if
         resolveInFrame == MultiBodyOmc.Types.ResolveInFrameB.frame_resolve
    ...
    parameter MultiBodyOmc.Types.ResolveInFrameB resolveInFrame
      =
      MultiBodyOmc.Types.ResolveInFrameB.world
    ...
    input Types.Color color=MultiBodyOmc.Types.Defaults.ForceColor
      "Color of arrow"
      annotation (Dialog(group="if animation = true", enable=animation));
  ...
  protected
    Interfaces.ZeroPosition zeroPosition if
         not (resolveInFrame == MultiBodyOmc.Types.ResolveInFrameB.frame_resolve)
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/WorldForce1.png\">
</p>
<p>
This leads to the following animation
</p>
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/WorldForce2.png\">
</p>
...
"));
  ...
  model WorldTorque
    ...
    input Types.Color color=MultiBodyOmc.Types.Defaults.TorqueColor
      "Color of arrow"
      annotation (Dialog(group="if animation = true", enable=animation));
    input Types.SpecularCoefficient specularCoefficient = world.defaultSpecularCoefficient
      "Reflection of ambient light (= 0: light is completely absorbed)"
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/WorldTorque1.png\">
</p>
<p>
This leads to the following animation
</p>
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/WorldTorque2.png\">
</p>
</HTML>
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/WorldForceAndTorque1.png\">
</p>
<p>
This leads to the following animation
</p>
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/WorldForceAndTorque2.png\">
</p>
</HTML>
"),   Documentation(info="
...
"));
  ...
  model Force
    ...
    Interfaces.Frame_resolve frame_resolve if
         resolveInFrame == MultiBodyOmc.Types.ResolveInFrameAB.frame_resolve
      "The input signals are optionally resolved in this frame"
      annotation (Placement(transformation(
          origin={40,100},
          extent={{-16,-16},{16,16}},
    ...
    parameter MultiBodyOmc.Types.ResolveInFrameAB
      resolveInFrame=
      MultiBodyOmc.Types.ResolveInFrameAB.frame_b
    ...
    input Types.Color forceColor=MultiBodyOmc.Types.Defaults.ForceColor
      " Color of force arrow" annotation (Dialog(group="if animation = true", enable=animation));
    input Types.Color connectionLineColor=MultiBodyOmc.Types.Defaults.SensorColor
  ...
  public
    MultiBodyOmc.Forces.Internal.BasicForce basicForce(resolveInFrame=resolveInFrame)
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/Force1.png\">
</p>
<p>
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/Force2.png\">
</p>
</html>
"));
  end Force;
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/Torque1.png\">
</p>
<p>
This leads to the following animation (the yellow cylinder
characterizes the line between frame_a and frame_b of the
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/Torque2.png\">
</p>
</HTML>
"));
  end Torque;
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/ForceAndTorque1.png\">
</p>
<p>
This leads to the following animation (the yellow cylinder
characterizes the line between frame_a and frame_b of the
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/ForceAndTorque2.png\">
</p>
</HTML>
"));
  end ForceAndTorque;
  ...
  model LineForceWithMass
    ...
    parameter Types.ShapeExtra lineShapeExtra=0.0 " Extra parameter for shape"
      annotation (Dialog(tab="Animation", group="if animateLine = true", enable=animateLine));
    input Types.Color lineShapeColor=MultiBodyOmc.Types.Defaults.SensorColor
      " Color of line shape"
      annotation (Dialog(tab="Animation", group="if animateLine = true", enable=animateLine));
...
<p>
In example
<a href=\"Modelica://MultiBodyOmc.Examples.Elementary.LineForceWithTwoMasses\">
MultiBodyOmc.Examples.Elementary.LineForceWithTwoMasses</a> the usage of this
line force element is shown and is compared with an alternative
implementation using a
<a href=\"Modelica://MultiBodyOmc.Joints.Assemblies.JointUPS\">
MultiBodyOmc.Joints.Assemblies.JointUPS</a> component.
The composition diagram of this example
is displayed in the figure below.
</p>
<IMG SRC=\"../Images/MultiBodyOmc/Examples/Elementary/LineForceWithTwoMasses1.png\">
<p>
...
<IMG SRC=\"../Images/MultiBodyOmc/Examples/Elementary/LineForceWithTwoMasses2.png\">
<p>
In the translational library there is the implicit assumption that
forces of components that have only one flange connector act with
opposite sign on the bearings of the component. This assumption
...
in the other flange connector.
  ...
  model Spring "Linear translational spring with optional mass"
    ...
    parameter Integer numberOfWindings=5 " Number of spring windings"
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input Types.Color color=MultiBodyOmc.Types.Defaults.SpringColor
      " Color of spring"
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input Types.SpecularCoefficient specularCoefficient = world.defaultSpecularCoefficient
      "Reflection of ambient light (= 0: light is completely absorbed)"
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Examples/Elementary/SpringWithMass.png\"
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Forces/Damper.png\">
</p>
</HTML>"),
      Icon(coordinateSystem(
          preserveAspectRatio=true,
...
"));
    ...
    model BasicWorldForce
      ...
      import SI = Modelica.SIunits;
      import MultiBodyOmc.Types.ResolveInFrameB;
      extends Interfaces.PartialOneFrame_b;
      Interfaces.Frame_resolve frame_resolve
        "The input signals are optionally resolved in this frame"
        annotation (Placement(transformation(
      ...
      Modelica.Blocks.Interfaces.RealInput force[3](each final quantity="Force", each
        ...
        annotation (Placement(transformation(extent={{-140,-20},{-100,20}},
              rotation=0)));
      parameter MultiBodyOmc.Types.ResolveInFrameB
        resolveInFrame=
        MultiBodyOmc.Types.ResolveInFrameB.world
...
<table border=1 cellspacing=0 cellpadding=2>
  ...
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.WorldForce\">WorldForce</a></td>
      <td valign=\"top\"> External force acting at the frame to which this component
           ...
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/ArrowForce.png\"></td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.WorldTorque\">WorldTorque</a></td>
      <td valign=\"top\"> External torque acting at the frame to which this component
           is connected and defined by 3 input signals,
           that are interpreted as one vector resolved in frame world, frame_b or frame_resolve. <br>
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/ArrowTorque.png\"></td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.WorldForceAndTorque\">WorldForceAndTorque</a></td>
      <td valign=\"top\"> External force and external torque acting at the frame
           ...
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/ArrowForce.png\"><br>
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/ArrowTorque.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.Force\">Force</a></td>
      <td valign=\"top\"> Force acting between two frames defined by 3 input signals
           ...
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/ArrowForce2.png\"></td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.Torque\">Torque</a></td>
      <td valign=\"top\"> Torque acting between two frames defined by 3 input signals
           resolved in frame world, frame_a, frame_b or in frame_resolve. <br>
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/ArrowTorque2.png\"></td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.ForceAndTorque\">ForceAndTorque</a></td>
      <td valign=\"top\"> Force and torque acting between two frames defined by 3+3 input signals
           resolved in frame world, frame_a, frame_b or in frame_resolve. <br>
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/ArrowForce2.png\"><br>
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/ArrowTorque2.png\"></td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.LineForceWithMass\">LineForceWithMass</a></td>
      <td valign=\"top\">  General line force component with an optional point mass
           ...
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/LineForceWithMass.png\"></td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.LineForceWithTwoMasses\">LineForceWithTwoMasses</a></td>
      <td valign=\"top\">  General line force component with two optional point masses
            on the connection line. The force law can be defined by a
            component of Modelica.Mechanics.Translational<br>
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/LineForceWithTwoMasses.png\"></td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.Spring\">Spring</a></td>
      <td valign=\"top\"> Linear translational spring with optional mass <br>
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/Spring2.png\"></td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.Damper\">Damper</a></td>
      <td valign=\"top\"> Linear (velocity dependent) damper <br>
           <IMG SRC=\"../Images/MultiBodyOmc/Forces/Damper2.png\"></td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.SpringDamperParallel\">SpringDamperParallel</a></td>
      <td valign=\"top\"> Linear spring and damper in parallel connection </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Forces.SpringDamperSeries\">SpringDamperSeries</a></td>
