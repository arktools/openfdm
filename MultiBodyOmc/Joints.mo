...
package Joints "Components that constrain the motion between two frames"
  ...
  model Prismatic
    ...
    import SI = Modelica.SIunits;
    extends MultiBodyOmc.Interfaces.PartialElementaryJoint;
    ...
    parameter MultiBodyOmc.Types.Axis n={1,0,0}
    ...
    parameter SI.Distance boxHeight=boxWidth "Height of prismatic joint box"
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input Types.Color boxColor=MultiBodyOmc.Types.Defaults.JointColor
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/Prismatic.png\">
</p>
...
"));
  ...
  model Revolute
    ...
    MultiBodyOmc.Interfaces.Frame_a frame_a
      "Coordinate system fixed to the joint with one cut-force and cut-torque"
      annotation (Placement(transformation(extent={{-116,-16},{-84,16}},
            rotation=0)));
    MultiBodyOmc.Interfaces.Frame_b frame_b
      "Coordinate system fixed to the joint with one cut-force and cut-torque"
    ...
    parameter MultiBodyOmc.Types.Axis n={0,0,1}
    ...
    parameter SI.Distance cylinderDiameter=world.defaultJointWidth
      ...
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input MultiBodyOmc.Types.Color cylinderColor=MultiBodyOmc.Types.Defaults.JointColor
      "Color of cylinder representing the joint axis"
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input MultiBodyOmc.Types.SpecularCoefficient
...
");
  ...
  protected
    outer MultiBodyOmc.World world;
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/Revolute.png\">
</p>
...
"));
  ...
  model RevolutePlanarLoopConstraint
    ...
    import T = MultiBodyOmc.Frames.TransformationMatrices;
    ...
    parameter SI.Distance cylinderDiameter=world.defaultJointWidth
      "Diameter of cylinder representing the joint axis"
      annotation (Dialog(group="if animation = true", enable=animation));
    input Types.Color cylinderColor=MultiBodyOmc.Types.Defaults.JointColor
      "Color of cylinder representing the joint axis"
      annotation (Dialog(group="if animation = true", enable=animation));
    input Types.SpecularCoefficient specularCoefficient = world.defaultSpecularCoefficient
      "Reflection of ambient light (= 0: light is completely absorbed)"
  ...
  */
    ...
    assert(noEvent(abs(e*r_rel_a) <= 1.e-10 and abs(e*ex_b) <= 1.e-10 and
        abs(e*ey_b) <= 1.e-10), "
The MultiBodyOmc.Joints.RevolutePlanarLoopConstraint joint is used as cut-joint of a
...
Either use instead joint MultiBodyOmc.Joints.Revolute or correct the
...
"));
  ...
  model Cylindrical
    ...
    import SI = Modelica.SIunits;
    extends MultiBodyOmc.Interfaces.PartialTwoFrames;
    parameter Boolean animation=true
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/Cylindrical.png\">
</p>
</HTML>
"),   Icon(coordinateSystem(
          preserveAspectRatio=true,
  ...
  model Universal "Universal joint (2 degrees-of-freedom, 4 potential states)"
    ...
    extends MultiBodyOmc.Interfaces.PartialTwoFrames;
    parameter Boolean animation=true "= true, if animation shall be enabled";
    parameter MultiBodyOmc.Types.Axis n_a={1,0,0}
      "Axis of revolute joint 1 resolved in frame_a" annotation (Evaluate=true);
    parameter MultiBodyOmc.Types.Axis n_b={0,1,0}
    ...
    MultiBodyOmc.Joints.Revolute revolute_a(
      n=n_a,
      ...
      animation=animation) annotation (Placement(transformation(extent={{-60,
              -25},{-10,25}}, rotation=0)));
    MultiBodyOmc.Joints.Revolute revolute_b(
      n=n_b,
      stateSelect=StateSelect.never,
      animation=animation,
      cylinderDiameter=cylinderDiameter,
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/Universal.png\">
</p>
</HTML>"),
      Icon(coordinateSystem(
          preserveAspectRatio=true,
  ...
  model Planar "Planar joint (3 degrees-of-freedom, 6 potential states)"
    ...
    parameter MultiBodyOmc.Types.Axis n={0,0,1}
      ...
      annotation (Evaluate=true);
    parameter MultiBodyOmc.Types.Axis n_x={1,0,0}
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/Planar.png\">
</p>
</HTML>
"),   Icon(coordinateSystem(
          preserveAspectRatio=true,
  ...
  model Spherical
    ...
    parameter SI.Distance sphereDiameter=world.defaultJointLength
      ...
      annotation (Dialog(group="if animation = true", enable=animation));
    input Types.Color sphereColor=MultiBodyOmc.Types.Defaults.JointColor
  ...
  protected
    ...
    parameter Frames.Quaternions.Orientation Q_start=
              MultiBodyOmc.Frames.to_Q(R_rel_start)
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/Spherical.png\">
</p>
</html>
"),   Icon(coordinateSystem(
          preserveAspectRatio=true,
  ...
  model FreeMotion
    ...
    parameter SI.Length arrowDiameter=world.defaultArrowDiameter
      ...
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input Types.Color arrowColor=MultiBodyOmc.Types.Defaults.SensorColor
      "Color of arrow"
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input Types.SpecularCoefficient specularCoefficient = world.defaultSpecularCoefficient
      "Reflection of ambient light (= 0: light is completely absorbed)"
    ...
    final parameter Frames.Orientation R_rel_start=
        MultiBodyOmc.Frames.axesRotations(sequence_start, angles_start,zeros(3))
      "Orientation object from frame_a to frame_b at initial time";
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/FreeMotion.png\">
</p>
</HTML>
"),   Icon(coordinateSystem(
          preserveAspectRatio=true,
  ...
  model SphericalSpherical
    ...
    parameter SI.Diameter rodDiameter=sphereDiameter/Types.Defaults.JointRodDiameterFraction
      ...
      annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
    input Types.Color rodColor=MultiBodyOmc.Types.Defaults.RodColor
    ...
    input Types.Color massColor=MultiBodyOmc.Types.Defaults.BodyColor
    ...
    parameter Boolean kinematicConstraint=true
      "= false, if no constraint shall be defined, due to analytically solving a kinematic loop (\"false\" should not be used by user, but only by MultiBodyOmc.Joints.Assemblies joints)"
      annotation (Dialog(tab="Advanced"));
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/SphericalSpherical.png\" ALT=\"model Joints.SphericalSpherical\">
</p>
...
that has this property.
  ...
  model UniversalSpherical
    ...
    parameter MultiBodyOmc.Types.Axis n1_a={0,0,1}
...
A MultiBodyOmc.Joints.UniversalSpherical joint (consisting of
...
use instead MultiBodyOmc.Joints.SphericalSpherical, if this is
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/UniversalSpherical.png\" ALT=\"model Joints.UniversalSpherical\">
</p>
<p>
...
MultiBodyOmc system in a <b>reference configuration</b> where <b>all frames</b>
...
<pre>
    MultiBodyOmc.Joints.UniversalSpherical jointUS(rRod_ia={1.2, 1, 0.2});
    MultiBodyOmc.Visualizers.FixedShape    shape(shapeType       = \"box\",
...
"),   Icon(coordinateSystem(
  ...
  model GearConstraint "Ideal 3-dim. gearbox (arbitrary shaft directions)"
    ...
    parameter MultiBodyOmc.Types.Axis n_b={1,0,0}
    ...
    MultiBodyOmc.Joints.Revolute actuatedRevolute_a(useAxisFlange=true, n=n_a, animation=false)
      annotation (Placement(transformation(extent={{-40,-10},{-60,10}},
            rotation=0)));
    MultiBodyOmc.Joints.Revolute actuatedRevolute_b(useAxisFlange=true,n=n_b, animation=false)
    ...
    Modelica.Mechanics.Rotational.Components.IdealGear idealGear(
      ...
      annotation (Placement(transformation(extent={{-10,30},{10,50}}, rotation=
              0)));
    MultiBodyOmc.Parts.FixedTranslation fixedTranslation1(animation=false, r=r_b)
      annotation (Placement(transformation(extent={{10,-10},{30,10}}, rotation=
              0)));
    MultiBodyOmc.Parts.FixedTranslation fixedTranslation2(animation=false, r=r_a)
      annotation (Placement(transformation(
          origin={-20,0},
          extent={{-10,-10},{10,10}},
          rotation=180)));
...
November 3-4, 2003, pp. 149-158</p>
  ...
  protected
    ...
    "Joint (no mass, no inertia) that describes an ideal rolling wheel set (two ideal rolling wheels connected together by an axis)"
      import SI = Modelica.SIunits;
     MultiBodyOmc.Interfaces.Frame_a frameMiddle
      ...
      MultiBodyOmc.Interfaces.Frame_a frame1
      ...
      MultiBodyOmc.Interfaces.Frame_b frame2
      ...
      MultiBodyOmc.Parts.Fixed fixed(                 r={0,0,
            wheelRadius}, animation=animation)
                          annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={0,-90})));
      MultiBodyOmc.Parts.FixedTranslation rod1(                 r={
            0,wheelDistance/2,0}, animation=animation)
        annotation (Placement(transformation(extent={{-8,-10},{-28,10}})));
      MultiBodyOmc.Joints.Prismatic prismatic1(animation=
            animation)                   annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={0,-66})));
      MultiBodyOmc.Joints.Prismatic prismatic2(
        n={0,1,0}, animation=animation)  annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=180,
            origin={-24,-50})));
      MultiBodyOmc.Joints.Revolute revolute(animation=animation)
                                         annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={0,-22})));
      MultiBodyOmc.Parts.FixedTranslation rod2(                 r={
            0,-wheelDistance/2,0}, animation=animation)
        annotation (Placement(transformation(extent={{12,-10},{32,10}})));
      MultiBodyOmc.Joints.Revolute revolute1(
        n={0,1,0},
        useAxisFlange=true,
        animation=animation)
        annotation (Placement(transformation(extent={{-34,-10},{-54,10}})));
      MultiBodyOmc.Joints.Revolute revolute2(
        n={0,1,0},
        useAxisFlange=true,
        animation=animation)
        annotation (Placement(transformation(extent={{40,-10},{60,10}})));
      MultiBodyOmc.Joints.Internal.RollingConstraintVerticalWheel
      ...
      MultiBodyOmc.Parts.Mounting1D mounting1D
  ...
  package Assemblies "Joint aggregations for analytic loop handling"
    ...
    model JointUPS
      ...
      MultiBodyOmc.Interfaces.Frame_a frame_ia
        "Coordinate system at origin of frame_a fixed at prismatic joint"
        annotation (Placement(transformation(
            origin={-80,100},
            extent={{-8,-8},{8,8}},
            rotation=270)));
      MultiBodyOmc.Interfaces.Frame_b frame_ib
      ...
      parameter SI.Diameter axisDiameter=sphereDiameter/Types.Defaults.
        ...
        annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
      input Types.Color axisColor=MultiBodyOmc.Types.Defaults.SensorColor
...
A MultiBodyOmc.Joints.Assemblies.JointUPS joint (consisting of
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/JointUPS.png\" ALT=\"model Joints.Assemblies.JointUPS\">
</p>
<p>
    ...
    model JointUSR
      ...
      MultiBodyOmc.Interfaces.Frame_b frame_ib
        ...
        annotation (Placement(transformation(
            ...
            extent={{-8,8},{8,-8}},
            rotation=270)));
      MultiBodyOmc.Interfaces.Frame_b frame_im
      ...
      parameter MultiBodyOmc.Types.Axis n1_a={0,0,1}
        ...
        annotation (Evaluate=true);
      parameter MultiBodyOmc.Types.Axis n_b={0,0,1}
      ...
      parameter SI.Diameter sphereDiameter=world.defaultJointLength
        ...
        annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
      input Types.Color sphereColor=MultiBodyOmc.Types.Defaults.
           JointColor
      ...
      parameter SI.Diameter rod1Diameter=sphereDiameter/Types.Defaults.
        ...
        annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
      input Types.Color rod1Color=MultiBodyOmc.Types.Defaults.
          RodColor
      ...
      parameter SI.Distance revoluteLength=world.defaultJointLength
        ...
        annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
      input Types.Color revoluteColor=MultiBodyOmc.Types.
          Defaults.JointColor
      ...
      MultiBodyOmc.Joints.Internal.RevoluteWithLengthConstraint
        revolute(
        animation=animation,
      ...
      MultiBodyOmc.Joints.UniversalSpherical rod1(
        animation=animation,
      ...
      MultiBodyOmc.Parts.FixedTranslation rod2(
        animation=animation,
        width=rod2Diameter,
        height=rod2Diameter,
        color=rod2Color,
        ...
        r=rRod2_ib) annotation (Placement(transformation(extent={{15,-20},{-25,
                20}}, rotation=0)));
      Sensors.RelativePosition relativePosition(resolveInFrame=MultiBodyOmc.Types.ResolveInFrameAB.frame_a)
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/JointUSR.png\" ALT=\"model Joints.Assemblies.JointUSR\">
</p>
<p>
This joint aggregation has no mass and no inertia and
introduces neither constraints nor potential state variables.
...
<pre>
    MultiBodyOmc.Joints.Assemblies.JointUSP jointUSR(rRod1_ia={1.2, 1, 0.2});
    MultiBodyOmc.Visualizers.FixedShape     shape(shapeType       = \"box\",
  ...
  <b>equation</b>
    ...
    model JointUSP
      ...
      parameter SI.Diameter rod1Diameter=sphereDiameter/Types.Defaults.
        ...
        "Diameter of rod 1 connecting the universal and the spherical joint"
        annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
      input Types.Color rod1Color=MultiBodyOmc.Types.Defaults.RodColor
        "Color of rod 1 connecting the universal and the spherical joint"
        annotation (Dialog(tab="Animation", group="if animation = true", enable=animation));
      parameter SI.Diameter rod2Diameter=rod1Diameter
      ...
      MultiBodyOmc.Joints.Internal.PrismaticWithLengthConstraint
        prismatic(
        animation=animation,
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/JointUSP.png\" ALT=\"model Joints.Assemblies.JointUSP\">
</p>
<p>
This joint aggregation has no mass and no inertia and
introduces neither constraints nor potential state variables.
...
<pre>
    MultiBodyOmc.Joints.Assemblies.JointUSP jointUSP(rRod1_ia={1.2, 1, 0.2});
    MultiBodyOmc.Visualizers.FixedShape     shape(shapeType       = \"box\",
  ...
  <b>equation</b>
    ...
    model JointSSR
      ...
      MultiBodyOmc.Joints.SphericalSpherical rod1(
        animation=animation,
        showMass=showMass,
        m=rod1Mass,
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/JointSSR.png\" ALT=\"model Joints.Assemblies.JointSSR\">
</p>
<p>
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/JointSSP.png\" ALT=\"model Joints.Assemblies.JointSSP\">
</p>
<p>
Besides an optional point mass in the middle of rod 1,
this joint aggregation has no mass and no inertia,
...
component).
    ...
    model JointRRR
      ...
      parameter Boolean animation=true "= true, if animation shall be enabled";
      parameter MultiBodyOmc.Types.Axis n_a={0,0,1}
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/JointRRR.png\" ALT=\"model Joints.Assemblies.JointRRR\">
</p>
<p>
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Joints/JointRRP.png\" ALT=\"model Joints.Assemblies.JointRRP\">
</p>
<p>
This joint aggregation introduces neither constraints nor state variables and
should therefore be used in kinematic loops whenever possible to
...
<a href=\"Modelica://MultiBodyOmc.UsersGuide.Tutorial.LoopStructures.AnalyticLoopHandling\">MultiBodyOmc.UsersGuide.Tutorial.LoopStructures.AnalyticLoopHandling</a>.
</p>
<p>
...
<table border=1 cellspacing=0 cellpadding=2>
  ...
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Assemblies.JointUPS\">JointUPS</a></td>
      <td valign=\"top\"> Universal - prismatic - spherical joint aggregation<br>
     <img src=\"../Images/MultiBodyOmc/Joints/JointUPS.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Assemblies.JointUSR\">JointUSR</a></td>
      <td valign=\"top\"> Universal - spherical - revolute joint aggregation<br>
     <img src=\"../Images/MultiBodyOmc/Joints/JointUSR.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Assemblies.JointUSP\">JointUSP</a></td>
      <td valign=\"top\"> Universal - spherical - prismatic joint aggregation<br>
     <img src=\"../Images/MultiBodyOmc/Joints/JointUSP.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Assemblies.JointSSR\">JointSSR</a></td>
     ...
     <img src=\"../Images/MultiBodyOmc/Joints/JointSSR.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Assemblies.JointSSP\">JointSSP</a></td>
      <td valign=\"top\"> Spherical - spherical - prismatic joint aggregation
           with an optional mass point at the rod connecting
           the two spherical joints<br>
     <img src=\"../Images/MultiBodyOmc/Joints/JointSSP.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Assemblies.JointRRR\">JointRRR</a></td>
      <td valign=\"top\"> Revolute - revolute - revolute joint aggregation for planar loops<br>
     <img src=\"../Images/MultiBodyOmc/Joints/JointRRR.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Assemblies.JointRRP\">JointRRP</a></td>
      <td valign=\"top\"> Revolute - revolute - prismatic joint aggregation for planar loops<br>
     <img src=\"../Images/MultiBodyOmc/Joints/JointRRP.png\">
      </td>
  </tr>
</table>
<p>
...
joints of package MultiBodyOmc.Joints would be used directly.
</p>
<p>
...
Try first to use another MultiBodyOmc.Joints.Assemblies.JointXXX component.
...
<p>
<b>Usually, this joint should not be used by a user of the MultiBodyOmc
library. It is only provided to built-up the MultiBodyOmc.Joints.Assemblies.JointXYZ
joints.</b>
</p>
...
They are designed to build up other models in the MultiBodyOmc library
...
<table border=1 cellspacing=0 cellpadding=2>
  <tr><th><b><i>Model</i></b></th><th><b><i>Description</i></b></th></tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Prismatic\">Prismatic</a>
      <td valign=\"top\">Prismatic joint and actuated prismatic joint
          (1 translational degree-of-freedom, 2 potential states)<br>
      <IMG SRC=\"../Images/MultiBodyOmc/Joints/Prismatic.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Revolute\">Revolute</a>
 </td>
  ...
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Cylindrical\">Cylindrical</a></td>
      <td valign=\"top\">Cylindrical joint (2 degrees-of-freedom, 4 potential states)<br>
      <IMG SRC=\"../Images/MultiBodyOmc/Joints/Cylindrical.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Universal\">Universal</a></td>
      <td valign=\"top\">Universal joint (2 degrees-of-freedom, 4 potential states)<br>
      <IMG SRC=\"../Images/MultiBodyOmc/Joints/Universal.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Planar\">Planar</a></td>
      <td valign=\"top\">Planar joint (3 degrees-of-freedom, 6 potential states)<br>
      <IMG SRC=\"../Images/MultiBodyOmc/Joints/Planar.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Spherical\">Spherical</a></td>
      <td valign=\"top\">Spherical joint (3 constraints and no potential states, or 3 degrees-of-freedom and 3 states)<br>
      <IMG SRC=\"../Images/MultiBodyOmc/Joints/Spherical.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.FreeMotion\">FreeMotion</a></td>
      <td valign=\"top\">Free motion joint (6 degrees-of-freedom, 12 potential states)<br>
      <IMG SRC=\"../Images/MultiBodyOmc/Joints/FreeMotion.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.SphericalSpherical\">SphericalSpherical</a></td>
      ...
      <IMG SRC=\"../Images/MultiBodyOmc/Joints/SphericalSpherical.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.UniversalSpherical\">UniversalSpherical</a></td>
      <td valign=\"top\">Universal - spherical joint aggregation (1 constraint, no potential states)<br>
      <IMG SRC=\"../Images/MultiBodyOmc/Joints/UniversalSpherical.png\">
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.GearConstraint\">GearConstraint</a></td>
      <td valign=\"top\">Ideal 3-dim. gearbox (arbitrary shaft directions)
      </td>
  </tr>
  <tr><td valign=\"top\"><a href=\"Modelica://MultiBodyOmc.Joints.Assemblies\">MultiBodyOmc.Joints.Assemblies</a></td>
