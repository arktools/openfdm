...
model World
  "Aircraft Control and Simulation, Lewis and Stevens, pg 36"
  ...
  parameter SI.AngularVelocity omega = 7.2921150e-5 "rotational rate";
  parameter Real GM(unit="m3/s2", min=0) = 3.986004418e14 "gravitational constant * mass"; 

  parameter SI.Length hTol = 0.001 "geodetic altitude conversion accuracy";
  parameter Real J2 = 1.0826267e-3 "-sqrt(5)*Cbar(2,0) WGS84 coefficient";

  // derived
  SI.Length b = a - f*a "semi-minor axis of planet";
  Real e = sqrt(a^2-b^2)/a "eccentricity of planet surface";
end World;
