...
package StabilityFrame
  ...
  model DatcomForceAndTorque
    import Modelica.SIunits.Conversions.*;
    extends ForceAndTorque;
    extends DatcomTables.DatcomCoefficients;
  ...
  model DatcomTableForceAndTorque
    import Modelica.SIunits.Conversions.*;
    extends ForceAndTorque;
    extends DatcomTables.DatcomCoefficients;
  ...
  end DatcomTableForceAndTorque;


  model SimpleDatcomForceAndTorque
    import Modelica.SIunits.Conversions.*;
    extends ForceAndTorque;
    extends DatcomTables.SimpleDatcomTablesEx;

    Real alpha_deg;
    Real beta_deg;

    // controls
    Real dFlap, dElevator, dAileron, dRudder;
  ...
  end SimpleDatcomForceAndTorque;
