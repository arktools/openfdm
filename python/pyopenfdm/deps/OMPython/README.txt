...
2012-08-04 [jgoppert@purdue.edu]
--------------------------------------------
- Moved OMPython into class OMShell so import doesn't cause server to start. Also added error handling and an argument to the shell ctor to set the build directory.
