...
package Sensors "Sensors to measure variables"
  ...
  model AbsoluteSensor
    ...
    extends MultiBodyOmc.Sensors.Internal.PartialAbsoluteSensor;

    Interfaces.Frame_resolve frame_resolve if resolveInFrame == MultiBodyOmc.Types.ResolveInFrameA.frame_resolve
    ...
    parameter MultiBodyOmc.Types.ResolveInFrameA resolveInFrame
      = MultiBodyOmc.Types.ResolveInFrameA.frame_a
  ...
  protected
    AbsoluteVelocity velocity(resolveInFrame=resolveInFrame) if get_v
        ...
        Placement(transformation(
          ...
          rotation=90,
          origin={-60,-60})));
    MultiBodyOmc.Sensors.AbsoluteAngles absoluteAngles(sequence=
  ...
  protected
    MultiBodyOmc.Sensors.TansformAbsoluteVector
      transformVector_a(
        frame_r_in=MultiBodyOmc.Types.ResolveInFrameA.world,
  ...
  protected
    ...
    MultiBodyOmc.Visualizers.Advanced.Arrow arrow(
      r_head=frame_a.r_0,
  ...
  protected
    AbsoluteVelocity absoluteVelocity(resolveInFrame=MultiBodyOmc.Types.ResolveInFrameA.world) if get_a
      annotation (Placement(transformation(
          extent={{10,-10},{-10,10}},
          rotation=90,
          origin={-20,-12})));
    AbsoluteAngularVelocity absoluteAngularVelocity(resolveInFrame=MultiBodyOmc.Types.ResolveInFrameA.world) if
         get_z
      annotation (Placement(transformation(extent={{40,-10},{60,10}},
          rotation=0)));
    Internal.ZeroForceAndTorque zeroForce1
      annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
    Internal.ZeroForceAndTorque zeroForce2 if resolveInFrame == MultiBodyOmc.Types.ResolveInFrameA.frame_resolve
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Sensors/AbsoluteSensor.png\">
</p>
...
<pre>
  ...
  model RelativeSensor
    ...
    import SI = Modelica.SIunits;
    extends MultiBodyOmc.Sensors.Internal.PartialRelativeSensor;

    Interfaces.Frame_resolve frame_resolve if
          resolveInFrame == MultiBodyOmc.Types.ResolveInFrameAB.frame_resolve or
          resolveInFrameAfterDifferentiation == MultiBodyOmc.Types.ResolveInFrameAB.frame_resolve
    ...
    parameter Boolean animation=true
      "= true, if animation shall be enabled (show arrow)";
    parameter MultiBodyOmc.Types.ResolveInFrameAB
      resolveInFrame=
      MultiBodyOmc.Types.ResolveInFrameAB.frame_a
  ...
  protected
    ...
    Blocks.Continuous.Der der2[3] if get_a_rel annotation (Placement(transformation(
          ...
          rotation=-90,
          origin={-25,-40})));
    MultiBodyOmc.Sensors.RelativeAngles relativeAngles(
  ...
  protected
    ...
    Internal.ZeroForceAndTorque zeroForce3 if resolveInFrame == MultiBodyOmc.Types.ResolveInFrameAB.frame_resolve
      annotation (Placement(transformation(extent={{70,50},{50,70}})));

  protected
    MultiBodyOmc.Sensors.TansformRelativeVector
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Sensors/RelativeSensor.png\">
</p>
<p>
Note, derivatives
...
<pre>
  ...
  model AbsolutePosition
    ...
    MultiBodyOmc.Interfaces.Frame_resolve frame_resolve if resolveInFrame ==
      MultiBodyOmc.Types.ResolveInFrameA.frame_resolve
  ...
  protected
    ...
    MultiBodyOmc.Interfaces.ZeroPosition zeroPosition if
      not (resolveInFrame == MultiBodyOmc.Types.ResolveInFrameA.frame_resolve)
...
<pre>
    r = MultiBodyOmc.Frames.resolve2(frame_a.R, frame_b.r_0);
</pre>
</html>"));
  ...
  model AbsoluteVelocity
    ...
    MultiBodyOmc.Interfaces.Frame_resolve frame_resolve if
      resolveInFrame == MultiBodyOmc.Types.ResolveInFrameA.frame_resolve
  ...
  protected
    Internal.BasicAbsolutePosition position(resolveInFrame=MultiBodyOmc.Types.ResolveInFrameA.world)
    ...
    TansformAbsoluteVector tansformAbsoluteVector(
      frame_r_in=MultiBodyOmc.Types.ResolveInFrameA.world,
        frame_r_out=resolveInFrame) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={50,0})));
    MultiBodyOmc.Interfaces.ZeroPosition zeroPosition
      annotation (Placement(transformation(extent={{-60,-60},{-80,-40}})));
    MultiBodyOmc.Interfaces.ZeroPosition zeroPosition1 if
         not (
      resolveInFrame == MultiBodyOmc.Types.ResolveInFrameA.frame_resolve)
      annotation (Placement(transformation(extent={{60,-60},{80,-40}})));
  equation
...
<pre>
    v0 = der(frame_a.r_0);
    v  = MultiBodyOmc.Frames.resolve2(frame_a.R, v0);
</pre>
  ...
  model AbsoluteAngles
    ...
    Modelica.Blocks.Interfaces.RealOutput angles[3](each final quantity="Angles", each
      ...
      annotation (Placement(transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=0)));
    parameter MultiBodyOmc.Types.RotationSequence sequence(
      min={1,1,1},
      max={3,3,3})={1,2,3}
  ...
  equation
    frame_a.f = zeros(3);
    frame_a.t = zeros(3);
    angles = MultiBodyOmc.Frames.axesRotationsAngles(
      frame_a.R,
      sequence,
      guessAngle1);
...
<pre>
    w = MultiBodyOmc.Frames.angularVelocity2(frame_a.R);
</pre>
  ...
  model RelativePosition
    ...
    MultiBodyOmc.Interfaces.Frame_resolve frame_resolve if resolveInFrame ==
      MultiBodyOmc.Types.ResolveInFrameAB.frame_resolve
  ...
  protected
    ...
    MultiBodyOmc.Interfaces.ZeroPosition zeroPosition if
      not (resolveInFrame == MultiBodyOmc.Types.ResolveInFrameAB.frame_resolve)
...
<pre>
    r_rel = MultiBodyOmc.Frames.resolve2(frame_a.R, frame_b.r_0 - frame_a.r_0);
</pre>
</html>"));
  ...
  protected
    RelativePosition relativePosition(resolveInFrame=MultiBodyOmc.Types.ResolveInFrameAB.frame_a)
      annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
    MultiBodyOmc.Interfaces.ZeroPosition zeroPosition if
      not (resolveInFrame == MultiBodyOmc.Types.ResolveInFrameAB.frame_resolve)
    ...
    TansformRelativeVector tansformRelativeVector(
        frame_r_in= MultiBodyOmc.Types.ResolveInFrameAB.frame_a,
...
<pre>
    ...
    v_rel   = MultiBodyOmc.Frames.resolveRelative(frame_a.R, frame_b.R, v_rel_a);
</pre>
  ...
  model RelativeAngles "Measure relative angles between two frame connectors"
    ...
    parameter SI.Angle guessAngle1=0
      "Select angles[1] such that abs(angles[1] - guessAngle1) is a minimum";
    MultiBodyOmc.Frames.Orientation R_rel
  ...
  equation
    ...
    frame_b.f = zeros(3);
    frame_b.t = zeros(3);
    R_rel = MultiBodyOmc.Frames.relativeRotation(frame_a.R, frame_b.R);
    angles = MultiBodyOmc.Frames.axesRotationsAngles(
      R_rel,
      sequence,
      guessAngle1);
...
<pre>
    ...
    w_rel = MultiBodyOmc.Frames.angularVelocity1(R_rel);
</pre>
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Sensors/Distance.png\">
</p>
<p>
...
differentiable everywhere. The derivative at zero distance is 3/(2*s_small).
  ...
  model CutForce "Measure cut force vector"
    ...
    input Types.Color forceColor=MultiBodyOmc.Types.Defaults.
    ...
    extends MultiBodyOmc.Sensors.Internal.PartialCutForceSensor;
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Sensors/CutForce.png\">
</p>
</HTML>"));
  end CutForce;
  ...
  model CutTorque "Measure cut torque vector"
    ...
    input Types.Color torqueColor=MultiBodyOmc.Types.Defaults.TorqueColor
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Sensors/CutTorque.png\">
</p>
</HTML>"));
  end CutTorque;
  ...
  model CutForceAndTorque "Measure cut force and cut torque vector"
    ...
    input SI.Diameter torqueDiameter=forceDiameter " Diameter of torque arrow"
                                  annotation (Dialog(group="if animation = true", enable=animation));
    input Types.Color forceColor=MultiBodyOmc.Types.Defaults.ForceColor
...
<p align=\"center\">
<IMG SRC=\"../Images/MultiBodyOmc/Sensors/CutForceAndTorque.png\">
</p>
</HTML>"));
...
as output signal <b>power</b>.
  ...
  model TansformAbsoluteVector "Transform absolute vector in to another frame"
    ...
    MultiBodyOmc.Interfaces.Frame_resolve frame_resolve if
     (frame_r_in  == MultiBodyOmc.Types.ResolveInFrameA.frame_resolve) or
     (frame_r_out == MultiBodyOmc.Types.ResolveInFrameA.frame_resolve)
    ...
    parameter MultiBodyOmc.Types.ResolveInFrameA frame_r_in=
    MultiBodyOmc.Types.ResolveInFrameA.frame_a
      "Frame in which vector r_in is resolved (1: world, 2: frame_a, 3: frame_resolve)";
    parameter MultiBodyOmc.Types.ResolveInFrameA frame_r_out=
                    frame_r_in
  ...
  protected
    Internal.BasicTransformAbsoluteVector basicTransformVector(frame_r_in=
      ...
      annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
    MultiBodyOmc.Interfaces.ZeroPosition zeroPosition if
      not (frame_r_in == MultiBodyOmc.Types.ResolveInFrameA.frame_resolve or
           frame_r_out == MultiBodyOmc.Types.ResolveInFrameA.frame_resolve)
...
transformed output vector as \"Real r_out[3]\";
  ...
  model TansformRelativeVector "Transform relative vector in to another frame"
    ...
    MultiBodyOmc.Interfaces.Frame_resolve frame_resolve if
     (frame_r_in  == MultiBodyOmc.Types.ResolveInFrameAB.frame_resolve) or
     (frame_r_out == MultiBodyOmc.Types.ResolveInFrameAB.frame_resolve)
      "Coordinate system in which r_in or r_out is optionally resolved"
      annotation (Placement(transformation(extent={{84,64},{116,96}}),
          iconTransformation(extent={{84,65},{116,97}})));
...
transformed output vector as \"Real r_out[3]\";
  ...
  package Internal "Internal package, should not be used by user"
    ...
    model PartialAbsoluteBaseSensor
      ...
      MultiBodyOmc.Interfaces.Frame_resolve frame_resolve
    ...
    model BasicAbsolutePosition
      ...
      import MultiBodyOmc.Types.ResolveInFrameA;
      extends
        MultiBodyOmc.Sensors.Internal.PartialAbsoluteBaseSensor;
      ...
      parameter MultiBodyOmc.Types.ResolveInFrameA
        resolveInFrame=
      MultiBodyOmc.Types.ResolveInFrameA.frame_a
    ...
    model BasicRelativePosition
      ...
      import MultiBodyOmc.Types.ResolveInFrameAB;
      extends
        MultiBodyOmc.Sensors.Internal.PartialRelativeBaseSensor;
    ...
    protected
      MultiBodyOmc.Frames.Orientation R1
...
"),     Icon(coordinateSystem(
    ...
    model BasicCutForce
      ...
      extends
        MultiBodyOmc.Sensors.Internal.PartialCutForceBaseSensor;
      Modelica.Blocks.Interfaces.RealOutput force[3](final quantity="Force", final unit
          =                                                                             "N")
        "Cut force resolved in frame defined by resolveInFrame"
           annotation (Placement(transformation(
