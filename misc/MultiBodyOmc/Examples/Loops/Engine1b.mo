...
model Engine1b
  ...
  Joints.RevolutePlanarLoopConstraint B2(
    ...
    cylinderDiameter=0.05) annotation (Placement(transformation(extent={{40,20},
            {60,40}}, rotation=0)));
  MultiBodyOmc.Joints.Revolute B1(
    n={1,0,0},
    cylinderLength=0.02,
...
It is similiar to
<a href=\"Modelica://MultiBodyOmc.Examples.Loops.Engine1a#diagram\">Loops.Engine1a</a>.
...
assembly joint \"MultiBodyOmc.Joints.Assemblies.<b>JointRRP</b>\".
This exchange of the kinematic loop is shown in
<a href=\"Modelica://MultiBodyOmc.Examples.Loops.Engine1b_analytic#diagram\">Loops.Engine1b_analytic</a>.
