...
model PlanarLoops_analytic
  ...
  MultiBodyOmc.Joints.Assemblies.JointRRR jointRRR1(
    rRod1_ia=r1a,
    rRod2_ib=r1b,
    checkTotalPower=true) annotation (Placement(transformation(
        ...
        extent={{-20,-20},{20,20}},
        rotation=270)));
  MultiBodyOmc.Joints.Revolute rev(useAxisFlange=true,w(fixed=true))
    annotation (Placement(transformation(
        origin={-56,-10},
        extent={{-10,-10},{10,10}},
        rotation=90)));
  MultiBodyOmc.Parts.FixedTranslation rod1(r=rv)
    annotation (Placement(transformation(
        origin={-56,30},
        extent={{-10,-10},{10,10}},
        rotation=90)));
  MultiBodyOmc.Parts.FixedTranslation rod2(r=rh)
  ...
  Modelica.Blocks.Sources.Sine sine(amplitude=0.7, freqHz=1)
    annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=270)));
  MultiBodyOmc.Joints.Assemblies.JointRRR jointRRR2(
    rRod1_ia=r2a,
    rRod2_ib=r2b,
    checkTotalPower=true) annotation (Placement(transformation(
        origin={30,0},
        extent={{-20,-20},{20,20}},
        rotation=270)));
  MultiBodyOmc.Parts.FixedTranslation rod3(r=rh)
  ...
  MultiBodyOmc.Parts.Body body2(
    ...
    r_CM=jointRRR2.rRod1_ia/2) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  MultiBodyOmc.Joints.Assemblies.JointRRR jointRRR3(
    rRod1_ia=r3a,
    rRod2_ib=r3b,
    checkTotalPower=true) annotation (Placement(transformation(
        origin={80,0},
        extent={{-20,-20},{20,20}},
        rotation=270)));
  MultiBodyOmc.Parts.FixedTranslation rod4(r=rh)
    annotation (Placement(transformation(extent={{40,-60},{60,-40}}, rotation=0)));
  MultiBodyOmc.Parts.Body body3(
    m=1,
    cylinderColor={155,155,155},
...
<p>
It is demonstrated how the MultiBodyOmc.Joints.Assemblies.JointRRR joint can be
...
<a href=\"Modelica://MultiBodyOmc.UsersGuide.Tutorial.LoopStructures.AnalyticLoopHandling\">
