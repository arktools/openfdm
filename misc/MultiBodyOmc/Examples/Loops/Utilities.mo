...
package Utilities "Utility models for Examples.Loops"
  ...
  model Cylinder "Cylinder with rod and crank of a combustion engine"
    ...
    MultiBodyOmc.Parts.BodyCylinder Piston(
      diameter=0.1,
      r={0,pistonLength,0},
      color={180,180,180},
      animation=animation) annotation (Placement(transformation(
          ...
          rotation=270)));
    MultiBodyOmc.Parts.BodyBox Rod(
    ...
    MultiBodyOmc.Parts.BodyBox Crank4(
      ...
      annotation (Placement(transformation(
          ...
          extent={{10,-10},{-10,10}},
          rotation=90)));
    MultiBodyOmc.Parts.BodyCylinder Crank3(
      r_shape={-0.01,0,0},
      length=0.12,
      diameter=0.03,
    ...
    MultiBodyOmc.Parts.BodyCylinder Crank1(
      diameter=0.05,
      r_shape={-0.01,0,0},
      length=0.12,
    ...
    MultiBodyOmc.Parts.BodyBox Crank2(
      height=0.05,
      widthDirection={1,0,0},
      width=0.02,
      r={0,crankPinOffset,0},
    ...
    Joints.RevolutePlanarLoopConstraint B1(
      ...
      cylinderDiameter=0.055) annotation (Placement(transformation(extent={{4,
              -27},{24,-7}}, rotation=0)));
    MultiBodyOmc.Parts.FixedTranslation Mid(r={crankPinLength/2,0,0}, animation=
          false) annotation (Placement(transformation(extent={{-6,-46},{14,-26}},
            rotation=0)));
    MultiBodyOmc.Joints.Prismatic Cylinder(useAxisFlange=true,
      s(start=-0.3),
      n={0,-1,0},
      boxWidth=0.02) annotation (Placement(transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=270)));
    MultiBodyOmc.Parts.FixedTranslation Mounting(r={crankLength,0,0}, animation=
          false) annotation (Placement(transformation(extent={{0,120},{20,140}},
            rotation=0)));
    MultiBodyOmc.Parts.FixedRotation CylinderInclination(
      r={crankLength - crankPinLength/2,0,0},
      n_y={0,cos(cylinderInclination),sin(cylinderInclination)},
      animation=false,
      rotationType=MultiBodyOmc.Types.RotationTypes.TwoAxesVectors)
      annotation (Placement(transformation(extent={{-60,30},{-40,50}}, rotation=
             0)));
    MultiBodyOmc.Parts.FixedRotation CrankAngle1(
      n_y={0,cos(crankAngleOffset),sin(crankAngleOffset)},
      animation=false,
      rotationType=MultiBodyOmc.Types.RotationTypes.TwoAxesVectors)
      annotation (Placement(transformation(extent={{-90,-100},{-70,-80}},
            rotation=0)));
    MultiBodyOmc.Parts.FixedRotation CrankAngle2(
      n_y={0,cos(-crankAngleOffset),sin(-crankAngleOffset)},
      animation=false,
      rotationType=MultiBodyOmc.Types.RotationTypes.TwoAxesVectors)
      annotation (Placement(transformation(extent={{60,-100},{80,-80}},
            rotation=0)));
    MultiBodyOmc.Parts.FixedTranslation CylinderTop(r={0,cylinderTopPosition,0},
...
of the cylinder. If this assumption is not fulfilled, an error occurs.
  ...
  model CylinderBase "One cylinder with analytic handling of kinematic loop"
    ...
    MultiBodyOmc.Parts.FixedTranslation Mid(animation=false, r={crankLength -
    ...
    MultiBodyOmc.Parts.FixedRotation CylinderInclination(
      r={crankLength - crankPinLength/2,0,0},
      animation=false,
      rotationType=MultiBodyOmc.Types.RotationTypes.RotationAxis,
      n={1,0,0},
      angle=cylinderInclination) annotation (Placement(transformation(extent={{
              -44,30},{-24,50}}, rotation=0)));
    MultiBodyOmc.Parts.FixedRotation CrankAngle(
      animation=false,
      rotationType=MultiBodyOmc.Types.RotationTypes.RotationAxis,
      n={1,0,0},
    ...
    Joints.Assemblies.JointRRP jointRRP(
      ...
      annotation (Placement(transformation(
          ...
          extent={{-20,20},{20,-20}},
          rotation=90)));
    MultiBodyOmc.Parts.BodyShape Rod(
      animation=animation,
      r={0,rodLength,0},
      ...
      I_33=rodInertia_33) annotation (Placement(transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=90)));
    MultiBodyOmc.Parts.BodyShape Piston(
      animation=animation,
      r={0,pistonLength,0},
    ...
    MultiBodyOmc.Parts.FixedTranslation Crank(animation=false, r={crankLength,0,0})
    ...
    replaceable model Cylinder = Cylinder_analytic_CAD constrainedby
      CylinderBase "Cylinder type"
         annotation (choices(choice(redeclare model Cylinder =
            ...
            Cylinder =
              MultiBodyOmc.Examples.Loops.Utilities.Cylinder_analytic
  ...
  partial model Engine1bBase "Model of one cylinder engine with gas force"
    ...
    MultiBodyOmc.Parts.BodyCylinder Piston(diameter=0.1, r={0,-0.1,0})
      annotation (Placement(transformation(
          origin={120,53},
          extent={{-10,30},{10,-30}},
          rotation=270)));
    MultiBodyOmc.Parts.BodyBox Rod2(
      widthDirection={1,0,0},
      width=0.02,
      height=0.06,
      color={0,0,200},
    ...
    inner MultiBodyOmc.World world annotation (Placement(
    ...
    MultiBodyOmc.Parts.BodyBox Crank4(
      ...
      r={0,-0.1,0}) annotation (Placement(transformation(
          ...
          extent={{10,-10},{-10,10}},
          rotation=90)));
    MultiBodyOmc.Parts.BodyCylinder Crank3(r={0.1,0,0}, diameter=0.03) annotation (
                                   Placement(transformation(extent={{41.5,-71},
              {61.5,-51}}, rotation=0)));
    MultiBodyOmc.Parts.BodyCylinder Crank1(diameter=0.05, r={0.1,0,0})
    ...
    MultiBodyOmc.Parts.BodyBox Crank2(
      ...
      r={0,0.1,0})
          ...
          extent={{-10,-10},{10,10}},
          rotation=90)));
    MultiBodyOmc.Parts.FixedTranslation Mid(r={0.05,0,0})
      annotation (Placement(transformation(extent={{30,-53},{50,-33}}, rotation=
             0)));
    MultiBodyOmc.Parts.FixedTranslation cylPosition(                 animation=false, r={0.15,
          0.55,0})
