...
model ThreeSprings "3-dim. springs in series and parallel connection"
  ...
  inner MultiBodyOmc.World world(animateWorld=animation)
  ...
  MultiBodyOmc.Forces.Spring spring1(
    ...
    animation=animation) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=270)));
  MultiBodyOmc.Parts.FixedTranslation bar2(animation=animation, r={0,0,0.3})
  ...
  MultiBodyOmc.Forces.Spring spring2(
    ...
    animation=animation) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=270)));
  MultiBodyOmc.Forces.Spring spring3(
    s_unstretched=0.1,
    width=0.1,
    coilWidth=0.005,
    numberOfWindings=5,
...
(here: MultiBodyOmc.Forces.Spring elements) can be connected together
