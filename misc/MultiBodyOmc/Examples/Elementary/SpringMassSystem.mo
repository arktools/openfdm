...
model SpringMassSystem "Mass attached with a spring to the world frame"
  ...
  MultiBodyOmc.Joints.Prismatic p1(useAxisFlange=true,
    n={0,-1,0},
    animation=animation,
    boxWidth=0.05,
  ...
  MultiBodyOmc.Parts.FixedTranslation bar2(animation=animation, r={0.3,0,0})
...
<li>In the right system the same model is defined. The difference is
    that a 3-dimensional spring from the MultiBodyOmc.Forces library is used.
